  ...
  <div class="max-w-5xl mx-auto px-6">
    ...
    <div class="mb-16" in:fly={{ y: 20, duration: 500 }}>
      <div class="bg-bg-card border border-neon-green/30 p-8 relative overflow-hidden">
        ...
        <div class="bg-bg-void p-4 font-mono text-sm overflow-x-auto">
        ...
        <div class="bg-bg-void p-4 font-mono text-sm">
    ...
    <div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        {#each installMethods as method, i}
          ...
          >
            ...
            <div class="bg-bg-void p-3 font-mono text-xs overflow-x-auto">
      ...
      <div class="mt-6 p-4 bg-bg-card border border-neon-magenta/20" in:fly={{ y: 20, duration: 500, delay: 200 }}>
